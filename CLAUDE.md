...
### Prossimi
1. **Deploy**: non ancora configurato per questo progetto (nessun Railway/Vercel collegato). Quando si è pronti a uscire dal locale, replicare il pattern di Commanderone (vedi sezione Stack & deploy in cima al file) — e completare di conseguenza il placeholder hosting nella Privacy Policy (sezione 5.5, IT+EN).
