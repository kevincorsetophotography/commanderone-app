...
// Registra un utente nuovo (username ed email sempre univoci) e ritorna token/utente.
async function registerUser(prefix = 'user') {
  ...
  return { username, email, password: PASSWORD, token: res.body.token, user: res.body.user };
}
